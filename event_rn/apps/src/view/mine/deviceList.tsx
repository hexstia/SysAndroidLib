        ...
        return (
            <View style={{ backgroundColor: '#fff', marginTop: 10, marginHorizontal: 15, borderRadius: 5, shadowColor: '#999', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.6 }}>
                ...
                <View style={{ marginTop: 10, marginHorizontal: 10, backgroundColor: '#F6F6F6', paddingHorizontal: 10, marginBottom: 14 }}>
                    ...
                    <Text style={{ color: '#333333', fontSize: 13, marginTop: 8, lineHeight: 16 }}>购买时间：{item.beginTime}</Text>
                    <Text style={{ color: '#333333', fontSize: 13, marginTop: 8, marginBottom: 12, lineHeight: 16 }}>购买时间：{item.beginTime}</Text>
                </View>
