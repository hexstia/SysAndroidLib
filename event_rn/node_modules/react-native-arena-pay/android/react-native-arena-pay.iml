...
<module external.linked.project.id=":react-native-arena-pay" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" external.system.module.group="event_rn" external.system.module.version="unspecified" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: ./../node_modules/react-native-arena-pay/android/libs/alipaySdk-20170922.jar" level="project" />
    <orderEntry type="library" name="Gradle: ./../node_modules/react-native-arena-pay/android/libs/open_sdk_r2973327_lite.jar" level="project" />
