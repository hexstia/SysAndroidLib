...
public class testOneAct extends Activity implements WebSocketCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logname.setText("18701418172");
        password.setText("123456789w");
        devid = "1989";
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Request osrequest = new Request.Builder()
                                .url("http://test.91lanjiang.com/tcss-api/cloudPhone/phone/screenshotCloudphone")
                                .post(osrequestBody)
                                .build();
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        RequestBody osrequestBody = new FormBody.Builder()
                                ...
                                .build();
                        Request osrequest = new Request.Builder()
                                .url("http://test.91lanjiang.com/tcss-api/cloudPhone/phone/resetDevice")
                                .post(osrequestBody)
                                .build();
                        Response osresponse = null;
                        try {
            ...
            public void run() {
                try {
                    ...
                    Request request = new Request.Builder()
                            .url("http://test.91lanjiang.com/tcss-api/tcssPlatform/user/getTempToken?timestamp=" + ts)
                            .build();
...
//                    Log.d("TAG", "token: " + token);
                    ...
                    Request prequest = new Request.Builder()
                            .url("http://test.91lanjiang.com/tcss-api/tcssPlatform/user/loginApp")
                            .post(prequestBody)
                            .build();
...
//                    Log.i("TAG", "权限令牌日志: " + presponseData);
    ...
    private void obtainList(String pto) {
        ...
        Request orequest = new Request.Builder()
                .url("http://test.91lanjiang.com/tcss-api/cloudPhone/phone/list")
                .post(orequestBody)
                .build();
